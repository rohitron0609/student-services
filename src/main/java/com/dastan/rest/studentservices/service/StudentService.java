package com.dastan.rest.studentservices.service;
...
import com.dastan.rest.studentservices.model.Course;
import com.dastan.rest.studentservices.model.Student;
...
public class StudentService{
	...
	static {
		 ...
		 Course courseOne = new Course("Course1", "Spring", "10Steps",
	        ...
	        Student student1 = new Student("Student1", "Ranga Karanam", "Hiker, Programmer and Architect",
	                new ArrayList<>(List.of(courseOne, courseTwo, courseThree, courseFour)));

	        Student student2 = new Student("Student2", "Satish T", "Hiker, Programmer and Architect",
	                new ArrayList<>(List.of(courseOne, courseTwo, courseThree, courseFour)));
	...
	public List<Course> retrieveCourses(String studentId){
		...
		if(studentId.equalsIgnoreCase("stud1")) {
			throw new RuntimeException("Something went W");
		}
